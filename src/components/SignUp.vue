...
<html lang="en">
  <head>
    ...
    <!-- <script
      src="https://kit.fontawesome.com/6e75322f16.js"
      ...
      <div class="overall">
          ...
          <p><h2>Sign Up</h2></p>
            ...
            <form>
              ...
              <div class="form-field">
                <button class="btn" type="CREATE-ACCOUNT"><a onClick="location.href='HomePage.html'">CREATE ACCOUNT</a></button>
              </div>             
            </form>
...
input:-webkit-autofill {
  box-shadow: 0 0 0 50px rgba(50, 95, 153, 0.974) inset; /* Change the color to your own background color */
...
form input {
  ...
  background-color: rgba(50, 95, 153, 0.974);
  display: block;
  padding: 15px 25px;
  font-size: 13px;
  color: #ffffff;
...
form .btn {
  ...
  font-weight: bold;
  margin-top: 15px;
  background-color: rgba(75, 136, 216, 0.974);
  color: white;
  border-radius: 8px;
  font-size: 15px;
}
